...
Config.set('graphics', 'height', '476')
...
last_reward = 0
scores = []
im = CoreImage("./images/MY_MASK1.png")
...
def init():
    ...
    img = PILImage.open("./images/my_mask.png").convert('L')
...
class Game(Widget):
    ...
    def serve_car(self):
        self.car.center = (self.width/2, self.height/2)  # Start from center
    ...
    def update(self, dt):
        ...
        if self.car.x < 30:  # Increased margin from edge
            self.car.x = 30
            last_reward = -5  # Increased penalty
...
class CarApp(App):
    ...
    def build(self):
        ...
        clearbtn = Button(text='clear', size_hint=(None, None), width=100, height=50)
        savebtn = Button(text='save', size_hint=(None, None), width=100, height=50, pos=(100, 0))
        loadbtn = Button(text='load', size_hint=(None, None), width=100, height=50, pos=(200, 0))
